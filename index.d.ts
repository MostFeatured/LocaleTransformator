 ...
 */
export async function localeToYamlFile(locale: DBILocale | TDBILocaleConstructor, path: string): void;

/**
 * @param yamlPath The Yaml File Path
 * @param localePath path to write "TDBILocaleConstructor as json" from yaml file
 */
export async function yamlFileToLocaleFile(yamlPath: string, localePath?: string): TDBILocaleConstructor;